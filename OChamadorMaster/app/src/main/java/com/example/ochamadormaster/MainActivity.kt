...
class MainActivity : AppCompatActivity() {
    ...
    fun discar(view: View){
        val uri = Uri.parse("tel:992313195")
        val it = Intent(Intent.ACTION_DIAL,uri)
        startActivity(it)
    }

    fun ligar(view: View){
        var uri = Uri.parse("tel:992313195")
        val it = Intent(Intent.ACTION_CALL,uri)
        var call = Manifest.permission.CALL_PHONE
    ...
    fun email(view: View){
        val uri = Uri.parse("mailto:valeria.cavalcante@ifpb.edu.br")
    ...
    fun compartilharTexto(view: View){
        ...
        it.putExtra(Intent.EXTRA_TEXT,"Texto para compartlhar")
